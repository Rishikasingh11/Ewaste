            ...
            <div class="main-nav">
                <div class="container">
                    ...
                    <div class="navbar-header page-scroll">
                        ...
                        <h1>
                            <a class="navbar-brand" href="index.jsp">E-waste alert portal</a>
                        </h1>
                    </div>
                  ...
                  <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li>
                                <a href="Adminlogin.jsp">SignIn(Only Officials)</a>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle effect-3" data-toggle="dropdown">Report Problem
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="biowaste.jsp">Bio-Waste</a>
                                    </li>
                                    <li>
                                        <a href="findcollectioncenters.jsp">Find Collection Centers or Locate</a>
                                    </li>
									
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle effect-3" data-toggle="dropdown">Staff
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="staffsignin.jsp">SignIn</a>
                                    </li>
                                    <li>
...
function myTimer() {
    var d = new Date();
    document.getElementById("demos").innerHTML = d.toLocaleTimeString();
}
</script>
...
<div class="cpy-right">
    ...
    <form name="form1" method="post" action="">
      ...
      <table width="527" border="1" align="center">
        <tr>
          <td width="287"><img src="images/f4.png" width="255" height="191" /></td>
     ...
     Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ewaste","root","mysql"); 
      ...
      while(rs.next())
      {
		 ...
		 if(found==1)
		 {
				 ...
				 session.setAttribute("user",utype); 
