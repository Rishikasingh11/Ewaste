			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a href="sviewcomplaints.jsp">View Complaints</a></li>
        ...
        while (rs.next())
        {
            out.println("<tr>");
                ...
                for(int x=1;x<=n;x++)
                {
                   ...
                   out.println("<td><b><a href=sviewcomplaints1.jsp?d="+s+">VIEW COMPLAINT LOCATION IN MAP</b><a/></td>");
