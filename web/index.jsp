22<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*" errorPage="" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
			...
			<div class="slider">
				<div class="img-responsive">
					<ul class="bxslider">				
						...
						<li><img src="img/slide2.jpg" alt="" width="1500" height="600"/></li>	
						<li><img src="img/slide3.jpg" alt="" width="1500" height="600"/></li>			
					</ul>
			  </div>	
			</div>
		</div>
	...
	<div class="content">
		<div class="grid">
		  <figure class="effect-zoe">
		    <img src="img/pic8.jpeg" alt="img25" width="480" height="360"/>
		    <figcaption>
                <h2>Waste collection<span></span></h2>
                <p class="icon-links"> <a href="#"><span class="icon-heart"></span></a> <a href="#"><span class="icon-eye"></span></a> <a href="#"><span class="icon-paper-clip"></span></a> </p>
                <p class="description">Zoe never had the patience of her sisters. She deliberately punched the bear in his face.</p>
              </figcaption>
          </figure>
		  <figure class="effect-zoe">
		    <img src="img/pic9.jpeg" alt="img26" width="480" height="360"/>
		    <figcaption>
					<h2>Waste seperation<span></span></h2>
					<p class="icon-links">
	...
	<div class="content">
		<div class="grid">
			<figure class="effect-zoe">
			  <img src="img/pic7.jpeg" alt="img27" width="480" height="360"/>
			  <figcaption>
					<h2>E-Waste<span></span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
						<a href="#"><span class="icon-eye"></span></a>
						<a href="#"><span class="icon-paper-clip"></span></a>					</p>
			...
			<figure class="effect-zoe">
				<img src="img/pic10.jpg" alt="img30" width="480" height="360"/>
				<figcaption>
					<h2>Plastics<span></span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
						<a href="#"><span class="icon-eye"></span></a>
