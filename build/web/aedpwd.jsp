			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a href="aedpwd.jsp">Edit Password</a></li>
				...
				<div class="img-responsive" >
					...
					<form name="form1" method="post" action="">
                      <table width="533" border="1" align="center">
                        <tr>
                          <td colspan="2"><div align="center"><b>Edit Password </b></div></td>
                          <td width="250" rowspan="5"><img src="images/a.jpg" width="225" height="225"></td>
                        </tr>
                        <tr>
                          <td width="117"><span class="style8"><div align="center"><b>Old Password </b></div></span></td>
                          <td width="144"><input type="text" name="textfield"></td>
                        </tr>
                        <tr>
                          <td><span class="style8"> <div align="center"><b>New Password</b></div></span></td>
                          <td><input type="password" name="textfield2"></td>
                        </tr>
                        <tr>
                          <td><span class="style6"> <div align="center">Confirm Password </div></span></td>
