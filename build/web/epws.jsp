            ...
            <div class="main-nav">
                <div class="container">
                    ...
                    <div class="navbar-header page-scroll">
                        ...
                        <h1>
                            <a class="navbar-brand" href="index.html">E-waste alert portal</a>
                        </h1>
                    </div>
                  ...
                  <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li>
                                <a href="epws.jsp">Edit Password</a>
                            </li>
                            <li>
                                <a href="viewp.jsp">View Problems</a>
                            </li>
...
<div class="cpy-right">
      ...
      <tr>
        <td><form id="form1" name="form1" method="post" action="#">
            <table width="93%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td colspan="5"><h1>Reset PassWord </h1></td>
              </tr>
              <tr>
                <td colspan="5">&nbsp;</td>
              </tr>
              <tr>
                <td width="33%">Old Password :</td>
                <td width="7%">&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td width="14%" valign="top"><input type="submit" name="Login" id="Login" value="Submit" /></td>
                <td width="19%" valign="top"><input type="reset" name="Login2" id="Login2" value="Reset" /></td>
              </tr>
            </table>
        </form>
	...
	rs=stmt.executeQuery("select * from staffreg where email="+"'"+email+"'");
		//String v1="",v2="";
		int found=0;
		while (rs.next())
		{ 
		  ...
		  String str="Update staffreg set email=? where pwd=?";
		  out.println(str);
