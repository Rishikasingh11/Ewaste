			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a href="search.jsp">Search </a></li>
					  ...
					  <div align="center">Search By 
                                        <select name="t1" id="t1">
                                          ...
                                          <option value="Receipt">Receipt</option>
                                           <option value="Staffreg">Staff</option>
                                        </select>
...
Connection con=DriverManager.getConnection(  "jdbc:mysql://localhost:3306/ewaste","root","mysql"); 
	...
	out.println("<body><h1><div align=center><strong><span class=style1>RECEIPT OR COMPLAINT OR STAFF DETAILS</span></strong></div></h1></body>");
